...
import webbrowser
import matplotlib.pyplot as plt
## LETRA EN CURSIVA PARA ESCRIBIR
#st.markdown(
#    """
    #<style>
    #.cursiva {
...
geo= pd.read_csv(r'C:\Users\katia\.vscode\examplecode\MODULO_3\TRABAJO FINAL\georeferencia-puntual-por-localidad.csv')
#INTRODUCCION ------------
...
with tab_plots:
    ...
    if st.button('Curso online Late Art'):
        url = 'https://www.scoolinary.com/collections?category=barista&gclid=CjwKCAiA85efBhBbEiwAD7oLQBpHLMTRinAzkmyH2i2vwZFcW6fM4oz92dnnssGrFw2XqWYA1ddlmBoCj50QAvD_BwE'
...
if st.sidebar.button('Comprar café'):

    url = 'https://docs.google.com/forms/d/e/1FAIpQLScrqnLsrJOBJw3SwR5PaZlVuJocYBB9R-X7IlwfNcC7rUnVaA/viewform?usp=sf_link'
    webbrowser.open_new_tab(url)    
